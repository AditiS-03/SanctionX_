...
export default function SignupPage() {
    ...
    const [formData, setFormData] = useState({
        fullName: '', dateOfBirth: '', gender: 'Male', mobile: '', email: '', password: '',
        currentAddress: '',
        panNumber: '', aadhaarNumber: '', panCardUrl: '', aadhaarCardUrl: '',
        panFileName: '', aadhaarFileName: '',
        profilePhotoUrl: '', profilePhotoFileName: '',
        employmentStatus: 'Salaried', workplace: '', monthlyIncome: '', 
        employmentProofUrl: '', employmentProofFileName: '',
        incomeDocUrl: '', incomeFileName: '', detectedIncome: null,
