    ...
    <footer className="bg-foreground text-background py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-t border-background/10 pt-8">
          <p className="text-center text-sm text-background/50 max-w-2xl mx-auto leading-relaxed mb-4">
          ...
          <p className="text-center text-[10px] text-background/30 max-w-2xl mx-auto leading-relaxed italic border-t border-background/5 pt-4">
            SanctionX operates as a Lending Service Provider (LSP) and partners with RBI-regulated financial institutions. It does not directly disburse loans.
          </p>
        </div>
